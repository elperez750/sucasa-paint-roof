...
const pressureWashingFAQs: FAQ[] = [
  {
    question: "How long does it typically take to pressure wash a house?",
    answer: "The time required for pressure washing a house varies depending on factors such as the size of the house, the level of dirt and grime, and the equipment used. Generally, pressure washing a standard-sized house can take anywhere from a few hours to a full day.",
  },
  {
    question: "Do I need to pressure wash my house regularly?",
    answer: "Yes, regular pressure washing is essential to prevent the buildup of dirt, mold, mildew, and other contaminants on your house's exterior surfaces. We recommend pressure washing your house at least once a year, ideally in the spring or fall, to maintain its cleanliness and appearance.",
  },
  {
    question: "What type of surfaces can be pressure washed?",
    answer: "Pressure washing is suitable for a wide range of surfaces, including siding, brick, concrete, wood, and even some types of roofing materials. However, it's essential to use the appropriate pressure settings and cleaning solutions to avoid damaging delicate surfaces.",
  },
  {
  ...
  },
  {
    ...
    answer: "The frequency of pressure washing your driveway and walkways depends on factors such as climate, foot traffic, and exposure to elements like dirt, oil, and debris. We recommend pressure washing your driveway and walkways at least once a year or as needed to maintain their cleanliness and safety.",
  },
  {
    question: "Can pressure washing remove stains from my deck or patio?",
    answer: "Yes, pressure washing can effectively remove stains, dirt, algae, mold, and mildew from decks, patios, and other outdoor surfaces. However, it's essential to use the appropriate pressure setting and cleaning solution to avoid damaging the wood or other materials.",
  },
  {
    question: "Is it safe to pressure wash my roof?",
    answer: "Pressure washing a roof can be risky and should only be done by professionals with experience in roof cleaning. Using too much pressure or improper techniques can damage roofing materials, leading to leaks, shingle loss, and other issues. We recommend hiring a professional roof cleaning service to ensure the safety and integrity of your roof.",
  },
  {
    question: "What are the benefits of professional pressure washing over DIY?",
    answer: "Professional pressure washing services offer several advantages over DIY methods, including access to professional-grade equipment, expertise in safely and effectively cleaning various surfaces, and the ability to customize cleaning solutions and techniques to meet your specific needs. Additionally, hiring a professional can save you time, effort, and potential damage to your property.",
  },
]
...
export default function PressureWashingServicesPage() {
  return (
    <>
      <Head>
        <title>Pressure Washing Services | Sucasa Paint and Roof Care</title>
        <meta name="description" content="Professional pressure washing services for homes and businesses. Restore your property's beauty with our expert cleaning solutions." />
      </Head>
      <Navbar />
      <main>
        <ImageHeader
          ...
          subheading="Restore your property's beauty with our expert cleaning solutions"
          color="white"
        />
        <CallToAction />
        ...
        <ServicesOffered />
        <ImageGrid 
          images={pressureWashingServices} 
          title="Our Pressure Washing Services"
          subtitle="Discover our range of expert cleaning solutions"
        />
        <FAQList faqs={pressureWashingFAQs} header="Common Pressure Washing Questions" />
      </main>
      <Footer />
    </>
  )
