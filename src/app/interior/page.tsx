...
const images = [
  { imageUrl: bathroom.src, imageHeading: "Bathroom Painting" },
  { imageUrl: cabinet.src, imageHeading: "Cabinet Painting" },
  { imageUrl: door.src, imageHeading: "Door Painting" },
  { imageUrl: kitchen.src, imageHeading: "Kitchen Painting" },
  { imageUrl: room.src, imageHeading: "Room Painting" },
  { imageUrl: trim.src, imageHeading: "Trim Painting" },
]
...
export default function InteriorPage() {
  return (
    <>
      <Head>
        <title>Interior Painting Services | Sucasa Paint and Roof Care</title>
        <meta name="description" content="Explore our interior painting services. Transform your space with our expert painters and high-quality materials." />
      </Head>
      <Navbar />
      <main>
        <ImageHeader
        ...
        >
          At Sucasa Paint and Roof Care, we understand that each space is as unique as the individuals who inhabit it. This belief drives our dedication to providing tailored solutions that cater to the specific needs and aspirations of every client. Whether it&apos;s a cozy cottage requiring a warm, inviting palette or a modern office space seeking a sleek, professional look, our team combines expertise with creativity to transform any area. We delve into the essence of each project, considering its distinct characteristics and the vision of those who live or work within it. Our approach ensures that every solution isn&apos;t just a service, but a personalized experience designed to elevate and enrich every space we touch.
        </ServiceBlock>
        <ServiceBlock
          image={staircase.src}
          ...
          order="right"
        >
          We believe that every interior space is unique, deserving of its own identity and character. That&apos;s why we offer tailored solutions for every room, ensuring that each space reflects your individual style and personality. Whether it&apos;s a cozy bedroom, a vibrant kitchen, or an elegant living room, our team of experts works closely with you to understand your vision and bring it to life. From color selection to meticulous execution, we strive to create spaces that not only meet but exceed your expectations. With our personalized approach, we transform every corner of your home into a sanctuary of comfort and style, where every detail is carefully considered and crafted to perfection.
        </ServiceBlock>
        <ServicesOffered />
        <ImageGrid 
          images={images} 
          title="Our Interior Painting Services"
          subtitle="Explore our range of interior painting solutions"
        />
        <FAQList faqs={faqItems} header="Common Interior Painting Questions" />
      </main>
      <Footer />
    </>
  )
