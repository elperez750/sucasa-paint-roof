...
const roofingServices = [
  { imageUrl: roofrepaircard.src, imageHeading: "Roof Repair" },
  { imageUrl: skylight.src, imageHeading: "Skylight Installation and Repair" },
  { imageUrl: roofventilation.src, imageHeading: "Roofing and Attic Ventilation" },
  { imageUrl: gutter.src, imageHeading: "Gutter Installation" },
  { imageUrl: chimney.src, imageHeading: "Chimney Flashing" },
  { imageUrl: guttercleaning.src, imageHeading: "Gutter Cleaning" },
]

const roofingFAQs: FAQ[] = [
  {
    question: "How long does it typically take to install a new roof?",
    answer: "The time required for roof installation varies depending on factors such as the size of the roof, the materials used, and weather conditions. Generally, installing a new roof can take anywhere from a few days to a couple of weeks.",
  },
  {
    question: "Do I need to clean my gutters regularly?",
    answer: "Yes, regular gutter maintenance is essential to prevent clogs and water damage to your home. We recommend cleaning your gutters at least twice a year, ideally in the spring and fall, to remove leaves, debris, and other obstructions.",
  },
  {
    question: "What type of roofing material is best suited for my climate?",
    answer: "The best roofing material for your climate depends on factors such as local weather patterns, temperature fluctuations, and exposure to elements like rain, snow, and sunlight. We can help you choose the most suitable roofing material for your specific location and environmental conditions.",
  },
  {
  ...
  },
  {
    ...
    answer: "Signs that your roof may need repairs or replacement include missing or damaged shingles, leaks, water stains on ceilings or walls, and visible signs of wear and tear. We offer professional roof inspections to assess the condition of your roof and recommend the appropriate course of action.",
  },
  {
    question: "Is it necessary to have gutter guards installed?",
    answer: "Gutter guards can be beneficial for preventing debris buildup and clogs in your gutters, reducing the need for frequent cleaning and maintenance. However, their effectiveness may vary depending on factors such as the type of debris in your area and the design of your gutter system.",
  },
  {
    question: "How can I prevent ice dams from forming on my roof?",
    answer: "To prevent ice dams, ensure proper attic insulation and ventilation to maintain consistent temperatures on your roof. Additionally, keep your gutters clean and free of debris to allow for proper drainage, and consider installing heating cables or roof de-icing systems in problem areas.",
  },
  {
    question: "What are the benefits of seamless gutters over traditional sectional gutters?",
    answer: "Seamless gutters offer several advantages over traditional sectional gutters, including reduced risk of leaks and clogs, improved aesthetics, and easier maintenance. With no seams or joints along the gutter length, seamless gutters provide better water flow and durability for long-term performance.",
  },
]
...
export default function RoofingServicesPage() {
  return (
    <>
      <Head>
        <title>Roofing and Gutter Services | Sucasa Paint and Roof Care</title>
        <meta name="description" content="Expert roofing and gutter services including repairs, installations, and maintenance. Protect your home with our professional solutions." />
      </Head>
      <Navbar />
      <main>
        <ImageHeader
          ...
          subheading="Protect your home with expert roofing and gutter solutions"
          color="white"
        />
        <CallToAction />
        ...
        <ServicesOffered />
        <ImageGrid 
          images={roofingServices} 
          title="Our Roofing and Gutter Services"
          subtitle="Discover our range of expert roofing and gutter solutions"
        />
        <FAQList faqs={roofingFAQs} header="Common Roof Repair and Gutter Questions" />
      </main>
      <Footer />
    </>
  )
