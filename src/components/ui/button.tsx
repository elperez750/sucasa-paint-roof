...
const Button: React.FC<ButtonProps> = ({ buttonType, label,backgroundColor, textColor, onClick, className = "" }) => {
    const getButtonClasses = () => {
        const baseClasses = `py-2 px-6 shadow focus:outline-none focus:ring-2 focus:ring-opacity-50 transition ease-in-out duration-150 font-poppins text-sm md:text-base mt-5 ${className}`;
